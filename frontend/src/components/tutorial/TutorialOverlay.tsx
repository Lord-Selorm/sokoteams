...
export default function TutorialOverlay() {
  const { isActive, hasCompletedTutorial, currentStep, nextStep, prevStep, skipTutorial, completeTutorial } = useTutorialStore();
  const { isAdmin } = useAuthStore();
  const steps = getTutorialSteps(isAdmin());
  ...
  if (hasCompletedTutorial && !isActive) return null;
